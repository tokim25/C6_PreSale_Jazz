...
define(['backbone', 'marionette', '../../vent', 'app/app', '/model', '/mainview'], function(Backbone, Marionette, vent, app, Model, MainView){
    ...
    var Module = Marionette.Object.extend({
        ...
        initView: function () {
            this.view = new MainView({model:this.model, soundPlayer: app.soundPlayer, chapter: this.chapter});
