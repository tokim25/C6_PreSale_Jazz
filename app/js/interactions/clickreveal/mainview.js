...
define([
    ...
    "ui/popup",
    "ui/splash",
    "text!templates/interactions/click_reveal/mainview.html",
    ...
    return Marionette.ItemView.extend({
        ...
        onRender: function() {
            var textObj = {
                ...
                'title': '',
                'body': '',
                'buttons': [{'id': 'continue', 'label': 'Close'}],
                'containerClass': 'music-popup'
            }
            ...
            TweenMax.set(this.$popupView, {autoAlpha: 0.0, top: '100%'});
        ...
        showText: function (content, delay) {
            ...
            TweenMax.set(this.$popupView, {autoAlpha: 1.0});
            TweenMax.to(this.$popupView, 0.5, {delay: delay, top: '0%'});
           // setTimeout(function () {
        ...
        hideText: function (delay) {
            ...
            TweenMax.to(this.$popupView, 0.5, {delay: delay, top: '100%'});
