...
define(['backbone', 'marionette', 'app/vent', 'app/app', 'interactions/quiz/model/model', 'interactions/quiz/view/mainview'], function(Backbone, Marionette, vent, app, Model, MainView){
    ...
    var Module = Marionette.Object.extend({
        ...
        onActivityComplete: function () {
            ...
            vent.trigger('quiz:commit-data', this.model.quizData);
