...
define(["backbone", "app/vent"], function (Backbone, vent) {
    ...
    var Model = Backbone.Model.extend({
        ...
        reinitialize: function () {
            ...
            this.curIndex = -1;
            this.numTotal = this.get('questions').length;
        },
        ...
        nextQuestion: function (n) {
            ...
            if(this.curIndex + n < this.numTotal) {
                this.curIndex += n;
        ...
        getnOFnString: function () {
            return (this.curIndex + 1) + ' of ' + this.numTotal;
        },
        ...
        updateInput: function (value) {
            this.curChoice = this.curQuestion;
            this.curChoice.result = value.toLowerCase() == this.curChoice.pattern.toLowerCase() ? 'correct' : 'wrong'
        },
        ...
        getSrcByID: function (id) {
            var manifest = this.get('assetManifest'),
                item = _.find(manifest, function (item) {return item.id == id});
            return item.src;
        },
