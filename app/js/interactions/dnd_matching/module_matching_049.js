...
define(['backbone', 'marionette', 'app/vent', 'app/app', 'interactions/dnd_matching/model', 'interactions/dnd_matching/matching_049_mainview'], function(Backbone, Marionette, vent, app, Model, MainView){
    ...
    var Module = Marionette.Object.extend({
        ...
        initView: function () {
            ...
            trace("mod1.view CID: "+this.view.cid, 1);
