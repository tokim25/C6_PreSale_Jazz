...
define(['backbone',
        ...
        '/model',
        '/mainview',
        '/clickreveal/priceguide',
        'text!templates/interactions/page_turner/clickreveal/priceguide.html'
    ],
    function(Backbone, Marionette, vent, app, Model, MainView, CRPriceguide, templatePriceguide){
